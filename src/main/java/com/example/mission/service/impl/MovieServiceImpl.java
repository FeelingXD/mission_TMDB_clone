...
public class MovieServiceImpl implements MovieService {
    ...
    public PopularMoviesDto getPopularMovies() {
        var streaming = movieRepository.getPopularMoviesByPlatform(Platform.STREAMING.name());
        var tv = movieRepository.getPopularMoviesByPlatform(Platform.TV.name());
        var rental = movieRepository.getPopularMoviesByPlatform(Platform.RENTAL.name());
        var theater = movieRepository.getPopularMoviesByPlatform(Platform.THEATER.name());
